  ...
  const faqs = [
    {
      ...
      answer: "Yes! Landwind is open-source under the MIT license.",
      rotate: true, // 👈 rotate icon for this one
    },
    {
      question: "Is there a Figma file available?",
      answer: "Yes, all components are designed in Figma.",
    },
    {
      question: "What are the differences between Landwind and Tailwind UI?",
      answer: "Landwind is free and open-source. Tailwind UI is paid.",
    },
    {
      question: "What about browser support?",
      answer: "Landwind supports all modern browsers.",
    },
  ];
  return (
